...
export const DUMMY_PRODUCT = [
...

  {
    ...
    status: true,
    quantity: 20,
    image_url: "https://example.com/laptop_y.jpg",
  },

  {
    ...
    status: true,
    quantity: 100,
    image_url: "https://example.com/headphones_z.jpg",
  },

  {
    id: 4,
    product: "Smart Watch W",
    categoryID: "CT4",
    name: "FitnessTracker W",
    price: 149,
    status: true,
    quantity: 75,
    image_url: "https://example.com/smartwatch_w.jpg",
  },

  {
    ...
    status: true,
    quantity: 30,
    image_url: "https://example.com/camera_a.jpg",
  },

  {
    id: 6,
    product: "Wireless Speaker B",
    categoryID: "CT3",
    name: "Hi-Fi Speaker B",
    price: 249,
    status: true,
    quantity: 60,
    image_url: "https://example.com/speaker_b.jpg",
  },

  {
    ...
    status: true,
    quantity: 25,
    image_url: "https://example.com/tablet_c.jpg",
  },

  {
    ...
    status: true,
    quantity: 15,
    image_url: "https://example.com/console_d.jpg",
  },

  {
    ...
    status: true,
    quantity: 40,
    image_url: "https://example.com/printer_e.jpg",
  },

  {
    id: 10,
    product: "External Hard Drive F",
    categoryID: "CT3",
    name: "Terabyte Storage F",
    price: 129,
    status: true,
    quantity: 80,
    image_url: "https://example.com/harddrive_f.jpg",
  },
];
